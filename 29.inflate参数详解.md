...
public class InflaterActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//将视图activity_inflater_item附加到根式图上,此时view.getLayoutParams()为LinearLayout.LayoutParams
...
//		View view=LayoutInflater.from(this).inflate(R.layout.activity_inflater_item, framelayout);
		...
		//不将视图activity_inflater_item附加到根式图上，只将这个root对象的LayoutParams属性附加到自身，此时view.getLayoutParams()为FrameLayout.LayoutParams
